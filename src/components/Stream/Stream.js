      ...
      <section id='streams' className='stream-section'>
        ...
        <ul className='stream-list'>
          <StreamItem
            ...
            description='Творческие встречи и мастер-классы с писателями Юрием Нечипоренко (г. Москва), Геннадием Прашкевичем и поэтом Юрием Татаренко, а также литературный квартирник. Встречи пройдут в трех крупных областных библиотеках Новосибирска: научной, молодежной и детской.'
          />
          <StreamItem

      ...
      <section id='streams' className='stream-section'>
        ...
        <ul className='stream-list'>
          <StreamItem
            ...
            description='Участников ждут встречи с известными новосибирскими графиками и живописцами: М. В. Паршиковым, С. С. Мосиенко. В программе авторская интерактивная лекция «100 лет русскому плакату», творческие встречи, в том числе в мастерской художника, и мастер-классы в разных художественных техниках.'
          />
          <StreamItem
            justifyType={'stream__item_right'}
            streamLogo={Dance}
            streamName='Танец, хореография'
            description='Студенты Новосибирского областного колледжа культуры и искусств представят лучшие номера в большой концертной программе, посвящённой бальным и народным танцам.'
          />
          <StreamItem
            streamLogo={Teatre}
          ...
          <StreamItem
            ...
            streamName='Анимация'
            description='Гости узнают о видах и техниках анимации, как развивается это направление,  и какие технологии создания анимации существуют сейчас. На мастер-классе с Елизаветой Харченко (г. Москва) участники разберут основные принципы создания анимации на основе готовой иллюстрации в программе After Effects.'
          />
        </ul>
